...
def main() -> None:
    ...
    # The overlay imports the real CRET 05/2026 module when deciding which
    # substitution rows need repair. Put the pinned 2.2.39 payload on sys.path
    # before testing that route; do not mock the product detector.
