...
"""TURTO 3.0.8 bootstrap – T-QP-VV to HIT substitution release."""
import hashlib
import importlib
...
INSTALLER_COMMIT = "a3d524b89e88799b757f17276359012e867b3e92"
INSTALLER_SHA256 = "60c3d3a1b64b21f30a921b7b72fc99671774859f25aae0dbf268a927e1c7a3a5"
RUNTIME_LAYOUT = "39"

ROOT = Path(__file__).resolve().parent
PROGRAM = ROOT / "Program"
ROOT_MARKER = ROOT / ".turto_runtime_current.ok"
PROGRAM_MARKER = PROGRAM / ".turto_runtime_3_0_8.ok"
STARTUP_LOG = ROOT / "Logy" / "startup.log"

CRITICAL_PROGRAM_SHA256 = {'app_runtime.pyw': '96176ca18a2c3ddba210023b5306eed9b8574325eed2f0de8c951ffe130c3639',
...
def _download_installer() -> Path:
    url = f"https://raw.githubusercontent.com/{REPOSITORY}/{INSTALLER_COMMIT}/updates/3.0.8/runtime_installer.py"
    ...
    for attempt in range(4):
        try:
            request = urllib.request.Request(
                ...
                headers={
                    "User-Agent": "TURTO-3.0.8-Bootstrap",
    ...
    raise RuntimeError(f"Nelze stáhnout runtime installer 3.0.8.\n{last}")
...
def _repair_runtime() -> None:
    ...
    try:
        ...
        if not PROGRAM_MARKER.is_file():
            raise RuntimeError("Opravený runtime nemá značku verze 3.0.8.")
...
def selftest() -> None:
    assert VERSION == "3.0.8" and RUNTIME_LAYOUT == "35"
