...
"""TURTO 3.0.23: incomplete import completion and physical HIT length 330 mm; existing customer files are read-only."""
import hashlib
import os
...
MARKER = ".turto_runtime_3_0_23.ok"

PAYLOADS = {'app_runtime.pyw': ('4baeed943c72a9f8c84a056867394bd2f10a9534',
                     'updates/3.0.23/app_runtime.pyw',
                     '292f58bda91959b3b7b248b1f7bf1754b183d05f2e12f7fe1da623f2f0cabd0a'),
 ...
 'bulk_import.py': ('4baeed943c72a9f8c84a056867394bd2f10a9534',
                    'updates/3.0.23/bulk_import.py',
                    '6aa9c9d2eff842c44e2977307df5131671119b0c1e5f621edf5f6b64e6e07fec'),
 ...
 'substitution_workspace.py': ('4baeed943c72a9f8c84a056867394bd2f10a9534',
                               'updates/3.0.23/substitution_workspace.py',
                               'f89d37a8852e212e0379f288697277b028ccf8511c144ac52729832bdf1cd6f4'),
 ...
 'project_ui_base.py': ('4baeed943c72a9f8c84a056867394bd2f10a9534',
                        'updates/3.0.23/project_ui_base.py',
                        'db0bfad58e824ada5dba59a8871c78c20ef67f7af436c8bf5e1bf373e94ad20f'),
 ...
 'source_completion.py': ('4baeed943c72a9f8c84a056867394bd2f10a9534',
                          'updates/3.0.23/source_completion.py',
                          '393ea0a6e5caa471cbb593adb9b1c64c87b1b42f62a8bf180d7d190dd66fc2ff'),
...
def selftest() -> None:
    assert VERSION == "3.0.23" and RUNTIME_LAYOUT == "54"
