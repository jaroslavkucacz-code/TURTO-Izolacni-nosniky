...
def leviat_candidates(raw, database):
    ...
    if q['hit_type']!='Auto':
        ...
        types=(q['hit_type'],)
    length_code={1000:100,500:50,330:33,250:25}.get(q['length'])
    if length_code is None: raise ValueError('Pro standardní HIT zvolte délku 1000, 500, 330 nebo 250 mm.')
