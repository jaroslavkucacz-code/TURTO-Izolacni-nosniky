...
"""TURTO 2.2.14 bootstrap – robust Program runtime import activation."""
...
INSTALLER_COMMIT = "ec8623bc640e6a0a6f7ef5f0b12097552e16d426"
INSTALLER_SHA256 = "82f9e03d6a49217ab6d09d3465d8615144e910ad3f897a4d926ad640aedd26ee"
RUNTIME_LAYOUT = "7"
...
def _download_installer() -> Path:
    url = (
        ...
        "updates/2.2.14/runtime_installer.py"
    )
    last = None
    ...
    for attempt in range(4):
        try:
            request = urllib.request.Request(
                ...
                headers={
                    "User-Agent": "TURTO-2.2.14-Bootstrap",
...
def _install_runtime() -> None:
    ...
    try:
        ...
        if not PROGRAM_REVISION.is_file():
            raise RuntimeError("Opravná runtime revize 2.2.14 nebyla vytvořena.")
