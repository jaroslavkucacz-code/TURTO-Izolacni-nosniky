...
"""TURTO 3.0.10 bootstrap – per-row HIT input units."""
import hashlib
import importlib
...
INSTALLER_COMMIT = "dc026bd32802700b8e80a1f47fc63d8908ac7519"
INSTALLER_SHA256 = "7d4328faf033f9c49a622565f2f747518bfa04ea9e0d8a7d99f7375294c5246c"
RUNTIME_LAYOUT = "41"

ROOT = Path(__file__).resolve().parent
PROGRAM = ROOT / "Program"
ROOT_MARKER = ROOT / ".turto_runtime_current.ok"
PROGRAM_MARKER = PROGRAM / ".turto_runtime_3_0_10.ok"
STARTUP_LOG = ROOT / "Logy" / "startup.log"

CRITICAL_PROGRAM_SHA256 = {'app_runtime.pyw': '18e5842cd03f1447fb44c2b3c0df80b4648ebba01e44dbfdd1b802fc2c52b159',
...
def _download_installer() -> Path:
    url = f"https://raw.githubusercontent.com/{REPOSITORY}/{INSTALLER_COMMIT}/updates/3.0.10/runtime_installer.py"
    folder = Path(tempfile.mkdtemp(prefix="turto_310_boot_"))
    ...
    for attempt in range(4):
        try:
            request = urllib.request.Request(
                ...
                headers={
                    "User-Agent": "TURTO-3.0.10-Bootstrap",
    ...
    raise RuntimeError(f"Nelze stáhnout runtime installer 3.0.10.\n{last}")
...
def _repair_runtime() -> None:
    ...
    try:
        ...
        if not PROGRAM_MARKER.is_file():
            raise RuntimeError("Opravený runtime nemá značku verze 3.0.10.")
...
def selftest() -> None:
    assert VERSION == "3.0.10" and RUNTIME_LAYOUT == "41"
