...
"""TURTO 2.2.30 – Peikko EBEA/TEBEA with verified runtime recovery."""
...
def _download_installer() -> Path:
    url = (
        ...
        "updates/2.2.30/runtime_installer.py"
    )
    temp_dir = Path(tempfile.mkdtemp(prefix="turto_2229_boot_"))
    ...
    for attempt in range(4):
        try:
            req = urllib.request.Request(
                ...
                headers={
                    "User-Agent": "TURTO-2.2.30-Bootstrap",
    ...
    raise RuntimeError(f"Nelze stáhnout runtime installer 2.2.30.\n{last}")
