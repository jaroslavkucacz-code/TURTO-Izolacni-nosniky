...
"""TURTO 3.0.9 bootstrap – manual HIT selection preservation."""
import hashlib
import importlib
...
INSTALLER_COMMIT = "b91fcd6ac4e426d75e258a2c8bcbf2b6e31b242b"
INSTALLER_SHA256 = "1789ada916b6575e7cbb37f823ebf6a985fdd307f53abf4afad866ec412123b5"
RUNTIME_LAYOUT = "40"

ROOT = Path(__file__).resolve().parent
PROGRAM = ROOT / "Program"
ROOT_MARKER = ROOT / ".turto_runtime_current.ok"
PROGRAM_MARKER = PROGRAM / ".turto_runtime_3_0_9.ok"
STARTUP_LOG = ROOT / "Logy" / "startup.log"

CRITICAL_PROGRAM_SHA256 = {'app_runtime.pyw': 'aeab7315b057e25cd07aefffe6987baf9441c59444855875ca2cd8deb0cc158b',
...
def _download_installer() -> Path:
    url = f"https://raw.githubusercontent.com/{REPOSITORY}/{INSTALLER_COMMIT}/updates/3.0.9/runtime_installer.py"
    ...
    for attempt in range(4):
        try:
            request = urllib.request.Request(
                ...
                headers={
                    "User-Agent": "TURTO-3.0.9-Bootstrap",
    ...
    raise RuntimeError(f"Nelze stáhnout runtime installer 3.0.9.\n{last}")
...
def _repair_runtime() -> None:
    ...
    try:
        ...
        if not PROGRAM_MARKER.is_file():
            raise RuntimeError("Opravený runtime nemá značku verze 3.0.9.")
...
def selftest() -> None:
    assert VERSION == "3.0.9" and RUNTIME_LAYOUT == "35"
