...
"""TURTO 2.2.4 – small verified bootstrap with generic recovery path."""
...
INSTALLER_COMMIT = "ed693f2e500d27cb5a9c5ebf4f275bc860e9fea2"
INSTALLER_SHA256 = "9415f17f66427b1b53ed3a5c3470bae4ea64ea0b6c6bee2012a96a386bc0c070"
RUNTIME_LAYOUT = "2"
...
def _download_installer() -> Path:
    url = (
        ...
        "updates/2.2.4/runtime_installer.py"
    )
    last = None
    ...
    for attempt in range(4):
        try:
            req = urllib.request.Request(
                ...
                headers={
                    "User-Agent": "TURTO-2.2.4-Bootstrap",
