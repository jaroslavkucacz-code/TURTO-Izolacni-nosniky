...
"""TURTO 2.2.4 – verified current runtime installation path.
...
RUNTIME_LAYOUT = "2"
PAYLOADS = {
    "app_runtime.pyw": ("1fa874ca3b5001fc1239a7c016412dea67efedb4", "updates/2.2.4/app_runtime.pyw", "affc3040a82d90a73e3696c9b1041fa80c39f2344e919723b85f102ac953e2e9"),
    "platform_workspace.py": ("2476f06bc4b27388dbe85cddeba616ecf85bd2bd", "updates/2.2.4/platform_workspace.py", "a9a9a85417f2cd4383dadc281d895f49b0b101c3621f824a73aae4531c6fe7b2"),
...
def _install_verified_base(root: Path) -> None:
    ...
    try:
        ...
        installer.write_bytes(_download(url, "TURTO-2.2.4-base"))
...
def install_runtime(root: Path | str) -> None:
    ...
    window = tk.Tk()
    window.title("TURTO 2.2.4 – obnova runtime")
    ...
    try:
        for index, (local, (commit, remote, expected)) in enumerate(PAYLOADS.items(), 1):
            ...
            source.write_bytes(
                _download_checked(commit, remote, expected, "TURTO-2.2.4-runtime")
            )
