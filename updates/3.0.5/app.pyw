...
"""TURTO 3.0.5 bootstrap – standard company PDF logo release."""
import hashlib
import importlib
...
INSTALLER_COMMIT = "f48c76a962ebdc35b3c802a0faac98dd25fb648a"
INSTALLER_SHA256 = "0689835b55f2d3e948d1fe7cefc4eea850b04ebb6063dde03c3df3cfb173dab4"
RUNTIME_LAYOUT = "36"

ROOT = Path(__file__).resolve().parent
PROGRAM = ROOT / "Program"
ROOT_MARKER = ROOT / ".turto_runtime_current.ok"
PROGRAM_MARKER = PROGRAM / ".turto_runtime_3_0_5.ok"
STARTUP_LOG = ROOT / "Logy" / "startup.log"

CRITICAL_PROGRAM_SHA256 = {'app_runtime.pyw': 'ac2a8a4e5af5ca32c02cab9dcfb7a2c7c67edcd24ef0dcfb4821e999da587ffe',
...
def _download_installer() -> Path:
    url = f"https://raw.githubusercontent.com/{REPOSITORY}/{INSTALLER_COMMIT}/updates/3.0.5/runtime_installer.py"
    ...
    for attempt in range(4):
        try:
            request = urllib.request.Request(
                ...
                headers={
                    "User-Agent": "TURTO-3.0.5-Bootstrap",
    ...
    raise RuntimeError(f"Nelze stáhnout runtime installer 3.0.5.\n{last}")
...
def _repair_runtime() -> None:
    ...
    try:
        ...
        if not PROGRAM_MARKER.is_file():
            raise RuntimeError("Opravený runtime nemá značku verze 3.0.5.")
...
def selftest() -> None:
    assert VERSION == "3.0.5" and RUNTIME_LAYOUT == "35"
