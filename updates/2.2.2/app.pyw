...
"""TURTO 2.2.2 – malý stabilní bootstrap s obecnou recovery cestou."""
...
INSTALLER_COMMIT = "563c3ed01187516e47d72c992aa6b0eb7f32dacb"
INSTALLER_SHA256 = "63e0fedc792d285a8bd20f08f640d4a611b09e5813ba0839c601ce73e91f7902"
RUNTIME_LAYOUT = "2"
...
def _download_installer() -> Path:
    url = (
        ...
        "updates/2.2.2/runtime_installer.py"
    )
    last = None
    ...
    for attempt in range(4):
        try:
            req = urllib.request.Request(
                ...
                headers={
                    "User-Agent": "TURTO-2.2.2-Bootstrap",
