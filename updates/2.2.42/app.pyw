...
"""TURTO 2.2.42 – startup hotfix + corrected CRET 05/2026 source VRd propagation."""
import hashlib
import importlib
...
INSTALLER_COMMIT = "03c498c63b270f533e66f27c9280492661f1f0b6"
INSTALLER_SHA256 = "03b6427a2740689ccb03639ee204cb5b011d00eb3c5fc57ac2bd54a5516d0c2f"
RUNTIME_LAYOUT = "26"

ROOT = Path(__file__).resolve().parent
PROGRAM = ROOT / "Program"
ROOT_MARKER = ROOT / ".turto_runtime_current.ok"
PROGRAM_MARKER = PROGRAM / ".turto_runtime_2_2_42.ok"
...
def _download_installer() -> Path:
    url = f"https://raw.githubusercontent.com/{REPOSITORY}/{INSTALLER_COMMIT}/updates/2.2.42/runtime_installer.py"
    folder = Path(tempfile.mkdtemp(prefix="turto_2242_boot_"))
    ...
    for attempt in range(4):
        try:
            req = urllib.request.Request(
                ...
                headers={"User-Agent":"TURTO-2.2.42-Bootstrap","Cache-Control":"no-cache, no-store","Pragma":"no-cache"},
            )
    ...
    raise RuntimeError(f"Nelze stáhnout runtime installer 2.2.42.\n{last}")
...
def _repair_runtime() -> None:
    ...
    try:
        ...
        if not PROGRAM_MARKER.is_file():
            raise RuntimeError("Opravený runtime nemá značku verze 2.2.42.")
