...
"""TURTO 2.2.8 – selectable PDF scope and workspace cleanup."""
...
def install(app_base: Any) -> None:
    ...
    if getattr(cls, "_turto_platform_workspace_228_installed", False):
        return
    ...
    cls._turto_platform_workspace_228_installed = True
