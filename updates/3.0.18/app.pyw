...
"""TURTO 3.0.18 bootstrap – visible startup and unified Schöck decoder."""
import hashlib
import importlib
...
INSTALLER_COMMIT = "f89c17a03c63761f247e0a337550ba36fc2fbeaa"
INSTALLER_SHA256 = "a50bb48134337e288cad8ccefd5c065955e728ead051f8f85639a287646d7258"
RUNTIME_LAYOUT = "49"

ROOT = Path(__file__).resolve().parent
PROGRAM = ROOT / "Program"
ROOT_MARKER = ROOT / ".turto_runtime_current.ok"
PROGRAM_MARKER = PROGRAM / ".turto_runtime_3_0_18.ok"
STARTUP_LOG = ROOT / "Logy" / "startup.log"

CRITICAL_PROGRAM_SHA256 = {'app_runtime.pyw': 'fe58a506bd28323bb58b99302b407ef44c4282a6d2a8e66939920e7cee582a6c',
...
def _download_installer() -> Path:
    url = f"https://raw.githubusercontent.com/{REPOSITORY}/{INSTALLER_COMMIT}/updates/3.0.18/runtime_installer.py"
    ...
    for attempt in range(4):
        try:
            request = urllib.request.Request(
                ...
                headers={
                    "User-Agent": "TURTO-3.0.18-Bootstrap",
    ...
    raise RuntimeError(f"Nelze stáhnout runtime installer 3.0.18.\n{last}")
...
def _repair_runtime() -> None:
    ...
    try:
        ...
        if not PROGRAM_MARKER.is_file():
            raise RuntimeError("Opravený runtime nemá značku verze 3.0.18.")
...
def selftest() -> None:
    assert VERSION == "3.0.18" and RUNTIME_LAYOUT == "49"
