...
"""TURTO 2.2.6 – small verified bootstrap with generic recovery path."""
...
INSTALLER_COMMIT = "f45cdf6a345e043a0d3502be672e3508d1536a28"
INSTALLER_SHA256 = "3f6cbd7a07f42a46deab004fdcc45c8f347998f83b7bda1b7006fec07c1c2a01"
RUNTIME_LAYOUT = "2"
...
def _download_installer() -> Path:
    url = (
        ...
        "updates/2.2.6/runtime_installer.py"
    )
    last = None
    ...
    for attempt in range(4):
        try:
            req = urllib.request.Request(
                ...
                headers={
                    "User-Agent": "TURTO-2.2.6-Bootstrap",
