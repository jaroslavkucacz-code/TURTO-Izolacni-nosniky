...
"""TURTO 2.2.6 – verified current runtime installation path.
...
RUNTIME_LAYOUT = "2"
PAYLOADS = {
    "app_runtime.pyw": ("de497ef8c78ad2e0b538fb5e13e4837650e340f8", "updates/2.2.6/app_runtime.pyw", "0d2ffdb4dfbfb4903358c831deea329d3d4e82189854d40ebc7e4ee346cef161"),
    "platform_workspace.py": ("0b18693c94b29a29cd6886ed31d74a43ae6ce24a", "updates/2.2.6/platform_workspace.py", "6e03ab9ed592c743b7cb5fddd5d4884912a9ad7a3d4769539f9eec874b2edb23"),
...
def _install_verified_base(root: Path) -> None:
    ...
    try:
        ...
        installer.write_bytes(_download(url, "TURTO-2.2.6-base"))
...
def install_runtime(root: Path | str) -> None:
    ...
    window = tk.Tk()
    window.title("TURTO 2.2.6 – obnova runtime")
    ...
    try:
        for index, (local, (commit, remote, expected)) in enumerate(PAYLOADS.items(), 1):
            ...
            source.write_bytes(
                _download_checked(commit, remote, expected, "TURTO-2.2.6-runtime")
            )
