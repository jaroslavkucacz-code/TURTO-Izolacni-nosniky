...
"""TURTO 2.0.2 small immutable bootstrap."""
...
VERSION = "2.0.2"
INSTALLER_COMMIT = "3c08d5387a3a62304f37498fb6f08081135a627e"
...
def _runtime_ready() -> bool:
    try:
        return (
            ...
            and (ROOT / "hit_workspace.py").is_file()
        )
    except Exception:
        return False
...
def _download_installer() -> Path:
    url = (
        ...
        + "/"
        + INSTALLER_COMMIT
        + "/updates/2.0.2/runtime_installer.py"
    )
    last = None
...
def _show_failure(exc: Exception) -> None:
    try:
        ...
        messagebox.showerror(
            ...
            "Dokončení opravy se nezdařilo. Databáze AKCÍ ani katalogy nebyly měněny.\n\n"
            + str(exc)
