...
"""TURTO 2.0.2 immutable runtime bootstrap."""
...
VERSION = "2.0.2"
PINNED_COMMIT = "52d1586bec59e55870fc0bd6db6d49bacb690af8"
REPOSITORY = "jaroslavkucacz-code/TURTO-Izolacni-nosniky"
ROOT = Path(__file__).resolve().parent
MARKER = ROOT / ".turto_runtime_2_0_2.ok"

FILES = {
    # 2.0.2 startup/grid hotfix
...
def _install_runtime() -> None:
    ...
    status = tk.Label(
        window,
        text="Instaluji opravu rozhraní platformy 2.0…",
        font=("Calibri", 10),
        bg="#F3F6F9",
        fg="#172230",
        justify="left",
