...
"""TURTO 3.0.12 bootstrap – smooth HIT UI."""
import hashlib
import importlib
...
INSTALLER_COMMIT = "6eb7bc9252696b3e16a0df58d9f222e3939a9cc0"
INSTALLER_SHA256 = "1801920c292fa95993e902c07d29ec76cbcced1e3368e4ca2897d6e6fc8142aa"
RUNTIME_LAYOUT = "43"

ROOT = Path(__file__).resolve().parent
PROGRAM = ROOT / "Program"
ROOT_MARKER = ROOT / ".turto_runtime_current.ok"
PROGRAM_MARKER = PROGRAM / ".turto_runtime_3_0_12.ok"
STARTUP_LOG = ROOT / "Logy" / "startup.log"

CRITICAL_PROGRAM_SHA256 = {'app_runtime.pyw': 'bd40eb41457988ff03c8c63375728090e913c57866a28700f28ee4bcc6bc408a',
...
def _download_installer() -> Path:
    url = f"https://raw.githubusercontent.com/{REPOSITORY}/{INSTALLER_COMMIT}/updates/3.0.12/runtime_installer.py"
    ...
    for attempt in range(4):
        try:
            request = urllib.request.Request(
                ...
                headers={
                    "User-Agent": "TURTO-3.0.12-Bootstrap",
    ...
    raise RuntimeError(f"Nelze stáhnout runtime installer 3.0.12.\n{last}")
...
def _repair_runtime() -> None:
    ...
    try:
        ...
        if not PROGRAM_MARKER.is_file():
            raise RuntimeError("Opravený runtime nemá značku verze 3.0.12.")
...
def selftest() -> None:
    assert VERSION == "3.0.12" and RUNTIME_LAYOUT == "43"
