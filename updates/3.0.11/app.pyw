...
"""TURTO 3.0.11 bootstrap – smooth HIT UI."""
import hashlib
import importlib
...
INSTALLER_COMMIT = "a7905f7b4e6cbd1d2325dd0dc9b33db88f84c3ad"
INSTALLER_SHA256 = "6a9bf43065bfd9e6108ada74f3fc107b998ca4c93517bc344617a9a5194a9208"
RUNTIME_LAYOUT = "42"

ROOT = Path(__file__).resolve().parent
PROGRAM = ROOT / "Program"
ROOT_MARKER = ROOT / ".turto_runtime_current.ok"
PROGRAM_MARKER = PROGRAM / ".turto_runtime_3_0_11.ok"
STARTUP_LOG = ROOT / "Logy" / "startup.log"

CRITICAL_PROGRAM_SHA256 = {'app_runtime.pyw': '9f9c0a9b6c0ea3ef5851ecf59cb57b635e2530028d420917050a0d2db4b1a91c',
...
def _download_installer() -> Path:
    url = f"https://raw.githubusercontent.com/{REPOSITORY}/{INSTALLER_COMMIT}/updates/3.0.11/runtime_installer.py"
    folder = Path(tempfile.mkdtemp(prefix="turto_311_boot_"))
    ...
    for attempt in range(4):
        try:
            request = urllib.request.Request(
                ...
                headers={
                    "User-Agent": "TURTO-3.0.11-Bootstrap",
    ...
    raise RuntimeError(f"Nelze stáhnout runtime installer 3.0.11.\n{last}")
...
def _repair_runtime() -> None:
    ...
    try:
        ...
        if not PROGRAM_MARKER.is_file():
            raise RuntimeError("Opravený runtime nemá značku verze 3.0.11.")
...
def selftest() -> None:
    assert VERSION == "3.0.11" and RUNTIME_LAYOUT == "42"
