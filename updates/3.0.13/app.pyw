...
"""TURTO 3.0.13 bootstrap – compact catalogue memory."""
import hashlib
import importlib
...
INSTALLER_COMMIT = "56425485ecadcc14b818afbba688af21c5412385"
INSTALLER_SHA256 = "57d56c291a4d2fdaccbe4ed974a0880403e6c1bc0eab0dd03badcc2ee87551b9"
RUNTIME_LAYOUT = "44"

ROOT = Path(__file__).resolve().parent
PROGRAM = ROOT / "Program"
ROOT_MARKER = ROOT / ".turto_runtime_current.ok"
PROGRAM_MARKER = PROGRAM / ".turto_runtime_3_0_13.ok"
STARTUP_LOG = ROOT / "Logy" / "startup.log"

CRITICAL_PROGRAM_SHA256 = {'app_runtime.pyw': '272e6b5d74eb4ee625cf2e93c1191ec1c98ee6f776ee506c55f48b3bc30858fd',
...
def _download_installer() -> Path:
    url = f"https://raw.githubusercontent.com/{REPOSITORY}/{INSTALLER_COMMIT}/updates/3.0.13/runtime_installer.py"
    folder = Path(tempfile.mkdtemp(prefix="turto_312_boot_"))
    ...
    for attempt in range(4):
        try:
            request = urllib.request.Request(
                ...
                headers={
                    "User-Agent": "TURTO-3.0.13-Bootstrap",
    ...
    raise RuntimeError(f"Nelze stáhnout runtime installer 3.0.13.\n{last}")
...
def _repair_runtime() -> None:
    ...
    try:
        ...
        if not PROGRAM_MARKER.is_file():
            raise RuntimeError("Opravený runtime nemá značku verze 3.0.13.")
...
def selftest() -> None:
    assert VERSION == "3.0.13" and RUNTIME_LAYOUT == "44"
