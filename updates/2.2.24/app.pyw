...
"""TURTO 2.2.24 – Ancon ED/ESD fix with verified runtime recovery."""
...
INSTALLER_COMMIT = "ed5bcde793afb9588445bb9b2a439d276c603b58"
INSTALLER_SHA256 = "c721de100fb06b34cbab45b7a15ed7cdb940d924177facdd8b57d3d8e186069c"
RUNTIME_LAYOUT = "17"

ROOT = Path(__file__).resolve().parent
PROGRAM = ROOT / "Program"
ROOT_MARKER = ROOT / ".turto_runtime_current.ok"
PROGRAM_MARKER = PROGRAM / ".turto_runtime_2_2_24.ok"
STARTUP_LOG = ROOT / "Logy" / "startup.log"

CRITICAL_PROGRAM_SHA256 = {
    "app_runtime.pyw": "ed0dcb300ed07d12d70dc7775964d1ab38c1035e4ececd7ee379189004b2c23b",
    "shear_dowels_current.py": "42025cb2bcf5e5bdb8d6ccd6f098bffb9ae49a10632e8da3d660c2d54200b35f",
...
def _download_installer() -> Path:
    ...
    temp_dir = Path(tempfile.mkdtemp(prefix="turto_2224_boot_"))
    ...
    raise RuntimeError(f"Nelze stáhnout runtime installer 2.2.24.\n{last}")
