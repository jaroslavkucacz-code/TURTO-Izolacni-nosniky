...
"""TURTO 3.0.17 bootstrap – visible startup and unified Schöck decoder."""
import hashlib
import importlib
...
PROGRAM_MARKER = PROGRAM / ".turto_runtime_3_0_17.ok"
STARTUP_LOG = ROOT / "Logy" / "startup.log"

CRITICAL_PROGRAM_SHA256 = {'app_runtime.pyw': 'fcaceca7891d423379557b25ee9791adc818ef301c2f470b55a88bbaa73e343b',
...
def _download_installer() -> Path:
    url = f"https://raw.githubusercontent.com/{REPOSITORY}/{INSTALLER_COMMIT}/updates/3.0.17/runtime_installer.py"
    ...
    for attempt in range(4):
        try:
            request = urllib.request.Request(
                ...
                headers={
                    "User-Agent": "TURTO-3.0.17-Bootstrap",
    ...
    raise RuntimeError(f"Nelze stáhnout runtime installer 3.0.17.\n{last}")
...
def _repair_runtime() -> None:
    ...
    try:
        ...
        if not PROGRAM_MARKER.is_file():
            raise RuntimeError("Opravený runtime nemá značku verze 3.0.17.")
