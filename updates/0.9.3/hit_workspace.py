...
class HitInputRow:
    ...
    def _read_values(self) -> tuple[int, int, DirectionalActions] | None:
...
class HitWorkspaceMixin:
    ...
    def _build_hit_tab(self, parent: ttk.Frame) -> None:
        ...
        ttk.Label(top, text=f"HIT-HP/SP • MVX / MVXL / ZVX / ZDX / DD / DVL / DDL • modul {HIT_MODULE_VERSION}", style="MutedCard.TLabel").grid(row=1, column=0, sticky="w", pady=(3, 0))
