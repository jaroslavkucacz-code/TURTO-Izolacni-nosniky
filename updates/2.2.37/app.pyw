...
"""TURTO 2.2.37 – transparent shear-dowel substitutions by catalogue VRd or actual VEd."""
...
INSTALLER_COMMIT = "f05fb5e7ff584dde04bf105b7a6a3021506b949c"
INSTALLER_SHA256 = "a8e0008e43e43397dcaa7eacf6be4763c7af8bbcc4929f8cfd3113c4fcf977b1"
RUNTIME_LAYOUT = "21"

ROOT = Path(__file__).resolve().parent
PROGRAM = ROOT / "Program"
ROOT_MARKER = ROOT / ".turto_runtime_current.ok"
PROGRAM_MARKER = PROGRAM / ".turto_runtime_2_2_37.ok"
...
def _download_installer() -> Path:
    ...
    temp_dir = Path(tempfile.mkdtemp(prefix="turto_2237_boot_"))
    ...
    for attempt in range(4):
        try:
            req = urllib.request.Request(
                ...
                headers={
                    "User-Agent": "TURTO-2.2.37-Bootstrap",
    ...
    raise RuntimeError(f"Nelze stáhnout runtime installer 2.2.37.\n{last}")
...
def selftest() -> None:
    ...
    assert "app_runtime_236.pyw" in CRITICAL_PROGRAM_SHA256
    assert "shear_substitution_237.py" in CRITICAL_PROGRAM_SHA256
