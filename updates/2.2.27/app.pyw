...
"""TURTO 2.2.27 – window restore guard with verified runtime recovery."""
...
INSTALLER_COMMIT = "8cc60a18a525558ae876ac68875dfb4f8d27fec9"
INSTALLER_SHA256 = "cdfa34ce9b5ea3423710fe7d862522da7f54a733c6f3a04621ef48d9b8851237"
RUNTIME_LAYOUT = "20"

ROOT = Path(__file__).resolve().parent
PROGRAM = ROOT / "Program"
ROOT_MARKER = ROOT / ".turto_runtime_current.ok"
PROGRAM_MARKER = PROGRAM / ".turto_runtime_2_2_27.ok"
STARTUP_LOG = ROOT / "Logy" / "startup.log"

CRITICAL_PROGRAM_SHA256 = {
    "app_runtime.pyw": "db384a8c7434f2443ad53e5ac75729301bffc942cf8be29a036d01486e452f8d",
...
def _download_installer() -> Path:
    url = (
        ...
        "updates/2.2.27/runtime_installer.py"
    )
    temp_dir = Path(tempfile.mkdtemp(prefix="turto_2227_boot_"))
    ...
    for attempt in range(4):
        try:
            req = urllib.request.Request(
                ...
                headers={
                    "User-Agent": "TURTO-2.2.27-Bootstrap",
    ...
    raise RuntimeError(f"Nelze stáhnout runtime installer 2.2.27.\n{last}")
...
def selftest() -> None:
    ...
    assert "app_runtime.pyw" in CRITICAL_PROGRAM_SHA256
