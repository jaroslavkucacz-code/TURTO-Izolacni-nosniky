...
"""TURTO 2.2.11 verified runtime overlay; actions.sqlite3 is never modified."""
...
BASE_COMMIT = "570afd46824049ac22dd82f462797dd5a3c15c3c"
BASE_PATH = "updates/2.2.10/runtime_installer.py"
BASE_SHA256 = "c8225bc86871f6ce5c36e5f12475eae6da0f4e253d297dd105ed21f74171f15a"
RUNTIME_LAYOUT = "4"
PAYLOADS = {
    "app_runtime.pyw": ("e133140634e09c79264394242942336f749e6b6c", "updates/2.2.11/app_runtime.pyw", "0ff42cbca634cc25cfde5efefb917c4ff267a871a7006329409a97cab4cbc80e"),
}
...
def install_runtime(root: Path | str) -> None:
    ...
    temp = Path(tempfile.mkdtemp(prefix="turto_2211_", dir=str(root)))
    try:
        base = temp / "base_installer.py"
        base.write_bytes(_download(BASE_COMMIT, BASE_PATH, BASE_SHA256, "TURTO-2.2.11-base"))
        ...
        for local, (commit, remote, expected) in PAYLOADS.items():
            ...
            source.write_bytes(_download(commit, remote, expected, "TURTO-2.2.11-runtime"))
