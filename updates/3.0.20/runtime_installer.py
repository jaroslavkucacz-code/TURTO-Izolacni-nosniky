...
"""TURTO 3.0.20: source element length in decoder and exports; existing customer files are read-only."""
import hashlib
import os
...
MARKER = ".turto_runtime_3_0_20.ok"

PAYLOADS = {'app_runtime.pyw': ('d15468cef0753c46866127e3458f691882d95167',
                     'updates/3.0.20/app_runtime.pyw',
                     'a6cb815233a5010f7fc7fbc5ecb258d6b016271f171865fd9df66f22ed37ace0'),
 ...
 'bulk_import_engine.py': ('d15468cef0753c46866127e3458f691882d95167',
                           'updates/3.0.20/bulk_import_engine.py',
                           'd26ba8c33a1a053c6c733ed6898f10155dfd1caf0d9c0d3390e701b6ea126dec'),
 'bulk_import.py': ('d15468cef0753c46866127e3458f691882d95167',
                    'updates/3.0.20/bulk_import.py',
                    '54ce7f34d076a055737e7f975407b2d523cdbb979e48001d296647893d830978'),
 ...
 'pdf_data_304.py': ('d15468cef0753c46866127e3458f691882d95167',
 ...
 'project_model.py': ('d15468cef0753c46866127e3458f691882d95167',
