...
"""TURTO 3.0.7 bootstrap – reviewed T-QP-VV decoder release."""
import hashlib
import importlib
...
INSTALLER_COMMIT = "84fac692ba8a0e323f199ba84b3e0c4dd5761f18"
INSTALLER_SHA256 = "486a22cd9c3881b31fc73377d0ad4626bd9597a86ddc8b732d79b640cc5b0194"
RUNTIME_LAYOUT = "38"

ROOT = Path(__file__).resolve().parent
PROGRAM = ROOT / "Program"
ROOT_MARKER = ROOT / ".turto_runtime_current.ok"
PROGRAM_MARKER = PROGRAM / ".turto_runtime_3_0_7.ok"
STARTUP_LOG = ROOT / "Logy" / "startup.log"

CRITICAL_PROGRAM_SHA256 = {'app_runtime.pyw': '639d9d363e0f0a6a0548f1aa3b63d86f21b53ed3a203916e8be10122554d50c1',
...
def _download_installer() -> Path:
    url = f"https://raw.githubusercontent.com/{REPOSITORY}/{INSTALLER_COMMIT}/updates/3.0.7/runtime_installer.py"
    ...
    for attempt in range(4):
        try:
            request = urllib.request.Request(
                ...
                headers={
                    "User-Agent": "TURTO-3.0.7-Bootstrap",
    ...
    raise RuntimeError(f"Nelze stáhnout runtime installer 3.0.7.\n{last}")
...
def _repair_runtime() -> None:
    ...
    try:
        ...
        if not PROGRAM_MARKER.is_file():
            raise RuntimeError("Opravený runtime nemá značku verze 3.0.7.")
...
def selftest() -> None:
    assert VERSION == "3.0.7" and RUNTIME_LAYOUT == "35"
