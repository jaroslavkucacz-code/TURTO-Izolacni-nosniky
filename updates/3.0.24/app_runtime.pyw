...
"""TURTO 3.0.24 – Durable tables, compact workspaces and dimensional infills."""
...
import designation_format_321
import archive_catalog_322
...
designation_format_321.install(_base)
archive_catalog_322.install(_base)
import source_completion
source_completion.install(_base)
import infill
infill.install(_base)
