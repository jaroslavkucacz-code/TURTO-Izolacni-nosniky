...
"""TURTO 3.0.24 bootstrap – visible startup and unified Schöck decoder."""
import hashlib
import importlib
...
INSTALLER_COMMIT = "e52a22f685646e2fda9ddbdb7421bd2c4ac63951"
INSTALLER_SHA256 = "e04e95fcdc630e7ee5117cfc80b987322eafe3db6c9bf1e9c88a7b1a0bf06c80"
RUNTIME_LAYOUT = "55"

ROOT = Path(__file__).resolve().parent
PROGRAM = ROOT / "Program"
ROOT_MARKER = ROOT / ".turto_runtime_current.ok"
PROGRAM_MARKER = PROGRAM / ".turto_runtime_3_0_24.ok"
STARTUP_LOG = ROOT / "Logy" / "startup.log"

CRITICAL_PROGRAM_SHA256 = {'app_runtime.pyw': '5d190bbe1a6c19e7bb7a0f5d3e12268d32fea1266e9c47fd44525bd1687c135f',
 ...
 'bulk_import.py': 'e454fc3367a1418f5779dbce789a69b4a0a8e25c2824cdd55e31a508a5af71e8',
 ...
 'substitution_workspace.py': 'b9d8adbb6d6f2698431ac9abd89230f06bbe01d2bb79a6fe545193624472487b',
 ...
 'hit_core.py': '8f086fd28ad1f1bd68873c7f5aa398a5a8c8198958a949675daeb0b16b9262cf',
 'isokorb_families_304.py': 'dde6ad19e0d0737600fc54ad11306099bef3d8ac3e7b848ffb346eea4bb8615c',
 'pdf_data_304.py': '0d99acffb1b12aa622ca9764596a494abdf04cf0bca866449d2d72aa004add80',
 ...
 'hit_units_310.py': '8036cfc6603221d9fb1cc093d1a53de1f4b2299b9bb7366354579c2d7d6fc2c3',
 ...
 'table_controls.py': '9192408bed1e585d2688a45e0a0283ccdbbf3bfaa294f40098954025ac472308',
 ...
 'project_ui_base.py': '5c4a3d3ac01277d52359e9986758bb1640e9b4531bd860b484ce7bd6253d9480',
 ...
 'source_completion.py': '48b7fd73db693447bf50bd52b56993bbee905fa3142f3de16660dbe0db65cb95',
 ...
 'infill.py': '8530fac0d2908fc27492d575be1abdde7aca8ff09601dd3c0bb04905f20a2ba0'}
...
def _configure_dpi() -> None:
    """Run before the loading thread creates the first native HWND.

    Older installed EXE launchers have no DPI manifest. Updating Python
    sources must also repair those hosts; a new build manifest alone cannot.
    Keep the system-aware mode supported by the shipped Tk runtime.
    """
    ...
    try:
        ...
        if shcore.GetProcessDpiAwareness(None, ctypes.byref(awareness)) == 0 and awareness.value:
            return
