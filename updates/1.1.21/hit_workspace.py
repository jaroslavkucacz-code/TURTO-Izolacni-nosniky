...
"""TURTO ISO 1.1.21 direct HIT workspace compatibility layer.

The verified 1.1.17 calculation workspace remains the calculation base. This
layer adds quantity, virtualized scrolling, local proposal storage and PDF/XLSX
exports without changing the HIT calculation core or catalogue data.
"""
