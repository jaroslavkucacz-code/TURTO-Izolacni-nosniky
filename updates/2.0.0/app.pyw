...
"""TURTO 2.0.0 immutable runtime bootstrap."""
...
VERSION = "2.0.0"
PINNED_COMMIT = "4899ef28a2be4aec20e32514bb91e91f0f31bf7f"
...
def _install_runtime() -> None:
    temp_root = Path(tempfile.mkdtemp(prefix="turto_200_", dir=str(ROOT)))
    window = tk.Tk()
    window.title("TURTO 2.0 – dokončení aktualizace")
