...
"""TURTO 2.2.1 – stabilizovaná multi-domain pracovní plocha."""
...
def install(app_base: Any) -> None:
    ...
    if getattr(cls, "_turto_platform_workspace_current_installed", False):
        return
    ...
    cls._turto_platform_workspace_current_installed = True
