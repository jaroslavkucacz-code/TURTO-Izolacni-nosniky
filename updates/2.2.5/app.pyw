...
"""TURTO 2.2.5 – small verified bootstrap with generic recovery path."""
...
INSTALLER_COMMIT = "f014ee29d8c3e5f9313ad9dc217f8523b28ce57a"
INSTALLER_SHA256 = "d733d93a26a58e14d6c6599444585dfb3233cc2e9370360666fff1d15c0165fa"
RUNTIME_LAYOUT = "2"
...
def _download_installer() -> Path:
    url = (
        ...
        "updates/2.2.5/runtime_installer.py"
    )
    last = None
    ...
    for attempt in range(4):
        try:
            req = urllib.request.Request(
                ...
                headers={
                    "User-Agent": "TURTO-2.2.5-Bootstrap",
