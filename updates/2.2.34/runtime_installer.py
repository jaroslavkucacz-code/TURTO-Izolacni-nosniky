...
"""TURTO 2.2.34 – HALFEN HSD decoder overlay; actions.sqlite3 is never modified."""
...
PAYLOADS = {
    "app_runtime.pyw": (
        ...
        "5576cdae794c9c8fd4f566573acb55bb5e687b5fbcc5c3f1fb521afc0cfcc883",
    ),
    "halfen_hsd_2026.py": (
        PAYLOAD_COMMIT,
        "updates/2.2.34/halfen_hsd_2026.py",
        "805f811bee2a8302c2c8ced979ecd2c26a3c92fbe6fd1024940a28dd98e617be",
    ),
...
def _install_base(root: Path, temp: Path) -> None:
    ...
    installer.write_bytes(_download(BASE_COMMIT, BASE_PATH, BASE_SHA256, "TURTO-2.2.34-base"))
