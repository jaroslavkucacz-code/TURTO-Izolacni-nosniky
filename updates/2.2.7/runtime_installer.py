...
"""TURTO 2.2.7 – verified current runtime installation path.
...
RUNTIME_LAYOUT = "2"
PAYLOADS = {
    "app_runtime.pyw": ("57c3a080bc4e07dfb0b94ec3b54bda2f554f395a", "updates/2.2.7/app_runtime.pyw", "16114706cb28f59de286f7bbe22e2be081960b47e5313d1375871ae99cd06898"),
    "platform_workspace.py": ("c909f1d45acb8c9a58ba7cf73ca417b8ad48dac6", "updates/2.2.7/platform_workspace.py", "9a637f558184ef7ceddfed220b2b2e5c9ba88120e11616d1ea4253573cafbb1e"),
    "shear_catalogs_227.py": ("5c82c249d7ef2634df31a9f656c3cfc35eb61bfb", "updates/2.2.7/shear_catalogs_227.py", "b1e59c850451ae662e2bfc065db04ac8038f1dc3d2137776e9fcb314324ab44f"),
    "shear_ui_227.py": ("5b5510e856198d20b02110a0666105d81c386f02", "updates/2.2.7/shear_ui_227.py", "c73e459a7ad8340d54d0fdc6990c5be936bcf55d3896fb4bd719d7c7180bd94d"),
    "ui_cleanup_227.py": ("b2f8e82692e0bc5e714950bb9b933c6a54011d6a", "updates/2.2.7/ui_cleanup_227.py", "d0cd3db53079c3b9b926df95631b7aa7edb8e19fffa4ae500d979915dd73b120"),
    "substitution_guard.py": ("a1d8c97b8e0143e8bc0e5769ab49b2794632a377", "updates/2.2.6/substitution_guard.py", "81854ebef393b1ca93e51be9d44019caa3815f37482655d2ba3e96223d570486"),
    "ui_visibility.py": ("062e250a43ba46fc9ffdd698dbf22b1b04927ca8", "updates/2.2.6/ui_visibility.py", "85adf39c69316a44ee5e293bd632f77ef36e4d5f7d1c26d0c47aa96c9620b3e2"),
...
def _install_verified_base(root: Path) -> None:
    ...
    try:
        ...
        installer.write_bytes(_download(url, "TURTO-2.2.7-base"))
...
def install_runtime(root: Path | str) -> None:
    ...
    window = tk.Tk()
    window.title("TURTO 2.2.7 – obnova runtime")
    ...
    try:
        for index, (local, (commit, remote, expected)) in enumerate(PAYLOADS.items(), 1):
            ...
            source.write_bytes(
                _download_checked(commit, remote, expected, "TURTO-2.2.7-runtime")
            )
