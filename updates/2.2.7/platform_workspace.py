...
"""TURTO 2.2.7 – PohlCon/MAX FRANK shear dowels and final decoder cleanup."""
...
from ui_cleanup_227 import apply as apply_ui_cleanup

WORKSPACE_VERSION = "2.2.7"
...
def install(app_base: Any) -> None:
    ...
    if getattr(cls, "_turto_platform_workspace_227_installed", False):
        return
    ...
    cls._turto_platform_workspace_227_installed = True
