...
"""TURTO 3.0.3 bootstrap – branded major release."""
import hashlib
import importlib
...
INSTALLER_COMMIT = "742987b3434b18e947dc66cde715aff62ba537a7"
INSTALLER_SHA256 = "70385303d93424855b2287cd45f0413c5021a6a97ca477db23fb0abc7514fce9"
RUNTIME_LAYOUT = "34"

ROOT = Path(__file__).resolve().parent
PROGRAM = ROOT / "Program"
ROOT_MARKER = ROOT / ".turto_runtime_current.ok"
PROGRAM_MARKER = PROGRAM / ".turto_runtime_3_0_3.ok"
STARTUP_LOG = ROOT / "Logy" / "startup.log"

CRITICAL_PROGRAM_SHA256 = {'app_runtime.pyw': '77192b491a848f4da003beac8051c9cdf6659781aca1953bbd982040510f84a9',
...
def _download_installer() -> Path:
    url = f"https://raw.githubusercontent.com/{REPOSITORY}/{INSTALLER_COMMIT}/updates/3.0.3/runtime_installer.py"
    folder = Path(tempfile.mkdtemp(prefix="turto_303_boot_"))
    ...
    for attempt in range(4):
        try:
            request = urllib.request.Request(
                ...
                headers={
                    "User-Agent": "TURTO-3.0.3-Bootstrap",
    ...
    raise RuntimeError(f"Nelze stáhnout runtime installer 3.0.3.\n{last}")
...
def _repair_runtime() -> None:
    ...
    try:
        ...
        if not PROGRAM_MARKER.is_file():
            raise RuntimeError("Opravený runtime nemá značku verze 3.0.3.")
...
def selftest() -> None:
    assert VERSION == "3.0.3" and RUNTIME_LAYOUT == "34"
