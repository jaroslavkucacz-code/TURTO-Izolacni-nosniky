...
def create_project_row(result: QueryResult, *, position: str, quantity: int=1, note: str="", row_id: str|None=None) -> dict[str,Any]:
...
class ProjectDocument:
    ...
    def to_dict(self)->dict[str,Any]:
        self.touch(); return {"schema_version":PROJECT_SCHEMA_VERSION,"application":"TURTO – Databáze izolačních nosníků",
    ...
    def from_dict(cls,raw:dict[str,Any])->"ProjectDocument":
        ...
        if version not in {1,2,3}: raise ValueError("Soubor používá nepodporovanou verzi formátu projektu.")
