...
"""TURTO 2.2.41: CRET 05/2026 substitution-source correction."""
...
import shear_cret_sync_241
shear_cret_sync_241.install(_base)
...
def selftest() -> None:
    ...
    assert getattr(_base.ThermalConnectorApp, "_turto_cret_sync_241", False)
    shear_cret_sync_241.selftest()
