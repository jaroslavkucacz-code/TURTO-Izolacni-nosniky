...
"""TURTO 2.2.45 – family-aware Schöck Isokorb XT bulk resolver."""
import hashlib
import importlib
...
INSTALLER_COMMIT = "d881114aa486b94142b38aeccd45e7dfb467b999"
INSTALLER_SHA256 = "337dcb996e2de3c0b6138e9f89aabd7b75f9541b1a838f3f73c3878eedea51cf"
RUNTIME_LAYOUT = "29"

ROOT = Path(__file__).resolve().parent
PROGRAM = ROOT / "Program"
ROOT_MARKER = ROOT / ".turto_runtime_current.ok"
PROGRAM_MARKER = PROGRAM / ".turto_runtime_2_2_45.ok"
...
def _runtime_ready() -> bool:
    try:
        required = (
            "runtime_paths.py", "platform_workspace.py", "bulk_import_engine.py",
...
def _download_installer() -> Path:
    url = f"https://raw.githubusercontent.com/{REPOSITORY}/{INSTALLER_COMMIT}/updates/2.2.45/runtime_installer.py"
    folder = Path(tempfile.mkdtemp(prefix="turto_2245_boot_"))
    ...
    for attempt in range(4):
        try:
            request = urllib.request.Request(
                ...
                headers={
                    "User-Agent": "TURTO-2.2.45-Bootstrap",
    ...
    raise RuntimeError(f"Nelze stáhnout runtime installer 2.2.45.\n{last}")
...
def _repair_runtime() -> None:
    ...
    try:
        ...
        if not PROGRAM_MARKER.is_file():
            raise RuntimeError("Opravený runtime nemá značku verze 2.2.45.")
