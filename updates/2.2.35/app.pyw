...
"""TURTO 2.2.35 – Leviat / HALFEN HSD EC 10-E (03/2026) in shear-dowel decoder."""
...
INSTALLER_COMMIT = "26edac71252c3a13fdd27cf8e26145dda1e2c137"
INSTALLER_SHA256 = "b96b2818e68a7bec7fb8ae170c45799021062d3f7184d1503a6a2abd2cddabe2"
RUNTIME_LAYOUT = "21"

ROOT = Path(__file__).resolve().parent
PROGRAM = ROOT / "Program"
ROOT_MARKER = ROOT / ".turto_runtime_current.ok"
PROGRAM_MARKER = PROGRAM / ".turto_runtime_2_2_35.ok"
STARTUP_LOG = ROOT / "Logy" / "startup.log"

CRITICAL_PROGRAM_SHA256 = {
    "app_runtime.pyw": "8e4c7e8b5ec4a56379e8fa7d1b44ac8a9c6bb8a4a94ac322c29ee1079d7b4290",
...
def _download_installer() -> Path:
    url = (
        ...
        "updates/2.2.35/runtime_installer.py"
    )
    temp_dir = Path(tempfile.mkdtemp(prefix="turto_2235_boot_"))
    ...
    for attempt in range(4):
        try:
            req = urllib.request.Request(
                ...
                headers={
                    "User-Agent": "TURTO-2.2.35-Bootstrap",
    ...
    raise RuntimeError(f"Nelze stáhnout runtime installer 2.2.35.\n{last}")
