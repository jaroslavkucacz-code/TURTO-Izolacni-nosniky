...
"""TURTO 2.2.28 – Peikko EBEA/TEBEA identification with verified runtime recovery."""
...
INSTALLER_COMMIT = "dae9844d3d6f5150a31dc9a6191cef2c7d03f528"
INSTALLER_SHA256 = "a7cf8c9428529059bf3cc56a416a06eff1208c9f9af7a901baefbf19bb79acc7"
RUNTIME_LAYOUT = "21"
...
CRITICAL_PROGRAM_SHA256 = {
    "app_runtime.pyw": "a7920f4c0b1dd33f6ac9275b6f229a72fe5e28fe5ee21e5d6ae4be59b2796d4b",
    "app_runtime_227.pyw": "db384a8c7434f2443ad53e5ac75729301bffc942cf8be29a036d01486e452f8d",
    "peikko_connectors.py": "f37361ed1ab3ea3467de70b7b6a67ecf6e72536c00b9c9713c73a0911fea4044",
    ...
    try:
        for name, expected in CRITICAL_PROGRAM_SHA256.items():
            ...
            if hashlib.sha256(path.read_bytes()).hexdigest().lower() != expected:
                return False
        catalog = PROGRAM / "catalogs" / "peikko_ebea_tebea_identification.json"
...
def selftest() -> None:
    ...
    assert "peikko_connectors.py" in CRITICAL_PROGRAM_SHA256
