...
"""TURTO 2.2.28 – Peikko EBEA/TEBEA with verified runtime recovery."""
...
INSTALLER_COMMIT = "fe70411f90d697d5092ad54ead0caf6ad217591f"
INSTALLER_SHA256 = "8ea77d63573109cc9725646723906d7b375061c71cf4cccd4cbc7719ec63a1d3"
RUNTIME_LAYOUT = "21"

ROOT = Path(__file__).resolve().parent
PROGRAM = ROOT / "Program"
ROOT_MARKER = ROOT / ".turto_runtime_current.ok"
PROGRAM_MARKER = PROGRAM / ".turto_runtime_2_2_28.ok"
STARTUP_LOG = ROOT / "Logy" / "startup.log"

CRITICAL_PROGRAM_SHA256 = {
    "app_runtime.pyw": "fc353328509955a31fcbdfd58baff04a469d31948a9f1a5d05210a33d5716af1",
    "app_runtime_227.pyw": "db384a8c7434f2443ad53e5ac75729301bffc942cf8be29a036d01486e452f8d",
    "peikko_thermal_breaks.py": "2e086653870c5bd6e626e09f78d256b7f7aa213a3a23fcb3c590a0a0d196f2cb",
    "peikko_workspace.py": "c9f8c72aba6c7646ef56c71024185337c73244ba9e24e1e7ed39abaa38757197",
...
def _download_installer() -> Path:
    url = (
        ...
        "updates/2.2.28/runtime_installer.py"
    )
    temp_dir = Path(tempfile.mkdtemp(prefix="turto_2228_boot_"))
    ...
    for attempt in range(4):
        try:
            req = urllib.request.Request(
                ...
                headers={
                    "User-Agent": "TURTO-2.2.28-Bootstrap",
    ...
    raise RuntimeError(f"Nelze stáhnout runtime installer 2.2.28.\n{last}")
