...
"""TURTO 2.2.3 – verified current runtime installation path.
...
RUNTIME_LAYOUT = "2"
PAYLOADS = {
    "app_runtime.pyw": ("0cd03899c22bee8ccbbc016c55ee99bf3a414e50", "updates/2.2.3/app_runtime.pyw", "768b8e3c2ad259c303786ff7799f1a1d208121e4616f2c1834437d8dadae8bcf"),
    "platform_workspace.py": ("c24210c100d70404de2500e741b8f02a70a1c283", "updates/2.2.3/platform_workspace.py", "659e78038cdfc21db6e020a6257108fa6da6101d4dada7129c7c582959cff27a"),
...
def _install_verified_base(root: Path) -> None:
    ...
    try:
        ...
        installer.write_bytes(_download(url, "TURTO-2.2.3-base"))
...
def install_runtime(root: Path | str) -> None:
    ...
    window = tk.Tk()
    window.title("TURTO 2.2.3 – obnova runtime")
    ...
    try:
        for index, (local, (commit, remote, expected)) in enumerate(PAYLOADS.items(), 1):
            ...
            source.write_bytes(
                _download_checked(commit, remote, expected, "TURTO-2.2.3-runtime")
            )
