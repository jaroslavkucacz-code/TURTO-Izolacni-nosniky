...
"""TURTO 2.2.3 – stable bootstrap with verified runtime recovery."""
...
INSTALLER_COMMIT = "1059298cec513ac97b6fc2ca1d57c918ab47a39e"
INSTALLER_SHA256 = "de88c7a6cd008f3766689f058ec75e070b0f1f7ee8c3586aec53815f40e09e5d"
RUNTIME_LAYOUT = "2"
...
def _download_installer() -> Path:
    url = (
        ...
        "updates/2.2.3/runtime_installer.py"
    )
    last = None
    ...
    for attempt in range(4):
        try:
            req = urllib.request.Request(
                ...
                headers={
                    "User-Agent": "TURTO-2.2.3-Bootstrap",
