...
"""TURTO 2.2.3 – compact multi-domain workspace with consolidated help."""
...
def install(app_base: Any) -> None:
    ...
    if getattr(cls, "_turto_platform_workspace_223_installed", False):
        return
    ...
    cls._turto_platform_workspace_223_installed = True
