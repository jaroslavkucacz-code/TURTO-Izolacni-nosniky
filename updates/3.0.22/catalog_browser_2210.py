...
CATALOGS = (
    CatalogLink(
        "Izolační nosníky", "Schöck",
        "ARCHIV: Schöck Isokorb T – CZ/2023.1, duben 2023 (KL 2.0)",
        "Izolacni_nosniky/Schoeck/Schoeck_Isokorb_T_CZ_2023_1_archiv.pdf",
        'https://www.schoeck.com/viewfile/8280/ARCHIV_Technicke_informace_Schoeck_Isokorb_T_pro_elezobetonove_konstrukce_Duben_2023__8280__.pdf',
        "Zdroj T KL 2.0, str. 44–47. Načtená data: KL M1–M12, CV1/CV2; dvě nejasné buňky M10 vynechány. PDF obsahuje i další řady, jejichž data zde nejsou doplněna.",
    ),
    CatalogLink(
        "Izolační nosníky",
        "Leviat / HALFEN",
