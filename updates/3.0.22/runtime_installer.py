...
"""TURTO 3.0.22: source element length in decoder and exports; existing customer files are read-only."""
import hashlib
import os
...
MARKER = ".turto_runtime_3_0_22.ok"

PAYLOADS = {'app_runtime.pyw': ('6552fe64ebb841e7a3c529b666684bdfbc35eafd',
                     'updates/3.0.22/app_runtime.pyw',
                     '481d29d868f49fc9d69fe851a93caa8da78a985a7c7c2cefd400d76839990a6e'),
