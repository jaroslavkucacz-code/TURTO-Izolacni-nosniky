...
"""TURTO 3.0.19: ST/WT geometry and readable text; existing customer files are read-only."""
import hashlib
import os
...
MARKER = ".turto_runtime_3_0_19.ok"

PAYLOADS = {'app_runtime.pyw': ('04deeff098d6aad06ae44f51fb49092bc6bacde3',
                     'updates/3.0.19/app_runtime.pyw',
                     '3e45bf1d2eee02396473e8a12ddbc4c77d76209805e1f80c69e411df38fe11b6'),
 ...
 'shear_choice_318.py': ('51a3cf7b1a464219241b23114d7b85295edf56f3',
                         'updates/3.0.19/shear_choice_318.py',
 ...
 'hit_export_ui_127.py': ('04deeff098d6aad06ae44f51fb49092bc6bacde3',
                          'updates/3.0.19/hit_export_ui_127.py',
                          'efabed1442c8ea4a328820cc996970471d1f51561f87c36c884788c1612dcbb9'),
 'st_workspace_319.py': ('04deeff098d6aad06ae44f51fb49092bc6bacde3',
                         'updates/3.0.19/st_workspace_319.py',
                         'b27358ec313abb666895c060b2872f179286d1e3cb3886366f4cefd8ce5f2ab6'),
