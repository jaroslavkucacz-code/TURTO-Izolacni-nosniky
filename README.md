...
Současné smykové trny zobrazují katalogovou VRd a zdroj přímo v Dekodéru a předávají je do exportu. Uložené řádky se doplní při otevření. Dlouhé lišty se zalamují podle šířky okna, aktivní filtry jsou zvýrazněné a řádkové akce jsou bez výběru neaktivní. Import má jednotný název Načíst výkaz…; společný našeptávač nahrazuje nadbytečný seznam pouze Leviat.
